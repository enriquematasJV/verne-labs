...
(function (global) {
  ...
  // Únicamente los caracteres necesarios para números, operadores y los
  // nombres (Math, PI, E, sin, cos, tan, sqrt, abs, log10, log, exp,
  // floor, ceil, round, x) sobreviven a esta comprobación.
